...
<head>
    <meta charset="utf-8">
    <title>Ramesh Rasaiyan's Personal Website | Interests &amp; Hobbies </title>
        ...
        <div class="content-wrapper">
            <section class="content">
                <article class="main-article">
                    <header>
                        <h2 class="page-title">Ramesh's Hobbies & Interests</h2>
                    </header>
                    <div class="row">
                        <div class="single-column-gallery">
                            <div class="hobbies-intro">
                                <p class="home-content">Photography is part of my life and I have been taking photographs for the past 20 years. I am still learning lots of technics everyday. I started photography with the Yashica Electro 35 camera and after that played around with many Point and Shoot, SLR and DSLR cameras. This gallery is from my Flickr feed where I am member since 2008. Recently I started doing some acrylic painting and I have uploaded few of my art work also in the Flickr.</p>
                            </div>
                            <div class="flickr-gallery-wrapper">
                                <ul class="flickr-gallery"></ul>
                            </div>
                        </div>
                    </div>
                </article>
