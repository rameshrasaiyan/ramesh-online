                    ...
                    <div class="row">
                        <div class="single-column">
                            ...
                            <ul class="course-items">
                                <li class="course-item in-progress"><a href="http://www.bu.edu/csmet/cs601/" target="_blank">MET CS 601 Web Application Development</a></li>
                                <li class="course-item not-started"><a href="http://www.bu.edu/csmet/cs520/" target="_blank">MET CS 520 Information Structures with Java</a></li>
