                                ...
                                <form action="update.php?id=<?php echo $id?>" method="post" name="updateProfileForm" id="updateProfileForm" onsubmit="return(validateUpdateForm());">
                                    <ul class="form-items">
                                        <li class="form-item">
                                            ...
                                            <input type="text" name="txtTitle" id="txtTitle" class="input-title" value="<?php echo !empty($title)?$title:'';?>" onfocus="removeError('txtTitle', 'input-title', 'titleMsg' );">
                                            <span class="error" id="titleMsg"></span>
                                        </li>
                                        <li class="form-item">
                                            <label for="txtCompany">Company Name: </label>
                                            <input type="text" name="txtCompany" id="txtCompany" class="input-company" value="<?php echo !empty($company)?$company:'';?>" onfocus="removeError('txtCompany', 'input-company', 'companyMsg' );">
                                            <span class="error" id="companyMsg"></span>
                                        </li>
                                        <li class="form-item">
                                            <label for="txtFrom">From Year: </label>
                                            <input type="text" name="txtFrom" id="txtFrom" class="input-from" value="<?php echo !empty($fyear)?$fyear:'';?>" onfocus="removeError('txtFrom', 'input-from', 'fyearMsg' );">
                                            <span class="error" id="fyearMsg"></span>
                                        </li>
                                        <li class="form-item">
                                            <label for="txtTo">To Year: </label>
                                            <input type="text" name="txtTo" id="txtTo" class="input-to" value="<?php echo !empty($tyear)?$tyear:'';?>" onfocus="removeError('txtTo', 'input-to', 'tyearMsg' );">
                                            <span class="error" id="tyearMsg"></span>
                                        </li>
                                        <li class="form-item">
                                            <label for="txtareaDesc">Description: </label>
                                            <textarea name="txtareaDesc" id="txtareaDesc" cols="30" rows="10" class="input-desc" onfocus="removeError('txtareaDesc', 'input-desc', 'descMsg' );"><?php echo !empty($desc)?$desc:'';?></textarea>
